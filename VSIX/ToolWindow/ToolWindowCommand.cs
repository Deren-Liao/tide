...
namespace ToolWindow
{
    ...
    internal sealed class ToolWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("33ca7c24-4826-4835-b8cf-d98dc8f04bf0");
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(ToolWindowTest), 0, true);
